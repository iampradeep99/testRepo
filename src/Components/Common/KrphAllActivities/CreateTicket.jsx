...
function CreateTicket({
  ...
  setStateCropLossIntimation,
  farmerAuthenticateByMobile,
  formValuesGI,
  setFormValuesGI,
  serviceSuccessState,
  ...
  const OnClickSelectedValidateOption = (selectedOption) => {
    ...
    if (selectedOption === "MN" && farmerAuthenticateByMobile === false) {
  ...
  const SavevalidateFarmerOnClick = async (pvalisRegistered) => {
    debugger;
    try {
      const formData = {
  ...
  const CreateTicketBAuthOptions = async (pCallingMasterID) => {
    try {
      ...
      const formData = {
        ...
        hasDocument: 0,
        attachmentPath: "",
        callingMasterID: pCallingMasterID,
              ...
              <div className={BizClass.validateFormHorizontal}>
                <Form.InputGroup errorMsg="">
                  <ul className={BizClass.ValidateTabGroup}>
                    ...
                    <button
                      type="button"
                      // A className={selectedValidateOption === "3" && BizClass.Active}
                      className={
                        selectedValidateOption === "3" && farmerAuthenticateByMobile === false
                          ? BizClass.Active
                          : farmerAuthenticateByMobile === true
                            ? BizClass.disabledradioFarmerAuthenticationBox
                            : null
                    ...
                    <button
                      type="button"
                      // A className={selectedValidateOption === "5" && BizClass.Active}
                      className={
                        selectedValidateOption === "5" && farmerAuthenticateByMobile === false
                          ? BizClass.Active
                          : farmerAuthenticateByMobile === true
                            ? BizClass.disabledradioFarmerAuthenticationBox
                            : null
                    ...
                    <button
                      ...
                      style={{ minWidth: "0px", width: "120px" }}
                    >
                      <div className={BizClass.ValidateTabCheckBox} />
                      <span>Offline</span>
                    </button>
              ...
              {selectedValidateOption !== "6" && selectedValidateOption !== "7" ? (
                ...
                <div className={BizClass.Content}>
                  <Form.Group column="4" controlwidth="360px">
                    ...
                    <Form.InputGroup label="Year" req="true" errorMsg={formValidationFarmersError["txtYearForNonRegFarmerOrOffline"]}>
                      <Form.InputControl
                        control="select"
                    ...
                    <Form.InputGroup label="Scheme" req="true" errorMsg={formValidationFarmersError["txtSchemeForNonRegFarmerOrOffline"]}>
                      <Form.InputControl
                        control="select"
                    ...
                    <Form.InputGroup label="State" req="true" errorMsg={formValidationFarmersError["txtStateForByNonRegFarmerOrOffline"]}>
                      <Form.InputControl
                        control="select"
                    ...
                    <Form.InputGroup label="District" req="true" errorMsg={formValidationFarmersError["txtDistrictForByNonRegFarmerOrOffline"]}>
                      <Form.InputControl
                        control="select"
                    ...
                    <Form.InputGroup
                      ...
                      req="true"
                      errorMsg={formValidationFarmersError["txtSubDistrictForByNonRegFarmerOrOffline"]}
                    >
                      <Form.InputControl
                        control="select"
                    ...
                    <Form.InputGroup
                      ...
                      req="true"
                      errorMsg={formValidationFarmersError["txtlevel5ByNonRegFarmerOrOffline"]}
                    >
                      <Form.InputControl
                        control="select"
                    ...
                    {lablelevel6NonRegFarmerOrOffline === null ? null : (
                      <Form.InputGroup
                        ...
                        req="true"
                        errorMsg={formValidationFarmersError["txtlevel6ByNonRegFarmerOrOffline"]}
                      >
                        <Form.InputControl
                          control="select"
                    ...
                    <Form.InputGroup
                      ...
                      req="true"
                      errorMsg={formValidationFarmersError["txtVillageForByNonRegFarmerOrOffline"]}
                    >
                      <Form.InputControl
                        control="select"
                    ...
                    {selectedValidateOption === "7" ? (
                      <>
                        <Form.InputGroup label="Insurance Company" req="true">
                          <Form.InputControl
                            control="select"
                            label=""
                        ...
                        <Form.InputGroup label="Policy No" req="true">
                          <Form.InputControl
                            control="input"
                            name="txtPolicy"
                            maxLength={20}
                        ...
                        <Form.InputGroup label="Application No" req="true">
                          <Form.InputControl
                            control="input"
                            name="txtApplication"
                            maxLength={50}
