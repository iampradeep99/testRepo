...
import BlockAssignModalLogic from "./Logic/BlockAssignModalLogic";
import BizClass from "./BlockAssignModal.module.scss";
...
function BlockAssignModal({ showfunc, selectedUserData }) {
  const {
    districtList,
  ...
  return (
    <Modal varient="full" title="Assign Block" show={showfunc} height="100vh" width="100vw">
      <Modal.Body>
          ...
          <Splitter varient="column" template="1fr 9px 1fr">
            <div className={BizClass.Card}>
              ...
              >
                ...
                <DataGrid.Column headerName="SubDistrict " field="SubDistrictMasterName" width={240} />
            ...
            <div className={BizClass.Card}>
              ...
              >
                <DataGrid.Column headerName="Block Name" field="BlockMasterName" width={150} />
                <DataGrid.Column
                  headerName="Action"
                  lockPosition="1"
                  pinned="left"
...
export default BlockAssignModal;

BlockAssignModal.propTypes = {
