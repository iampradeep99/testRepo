...
import SubDistrictAssignModalLogic from "./Logic/SubDistrictAssignModalLogic";
import BizClass from "./SubDistrictAssignModal.module.scss";
...
function SubDistrictAssignModal({ showfunc, selectedUserData }) {
  const {
    districtList,
  ...
  return (
    <Modal varient="full" title="Assign Sub District" show={showfunc} height="100vh" width="100vw">
      <Modal.Body>
          ...
          <Splitter varient="column" template="1fr 9px 1fr">
            <div className={BizClass.Card}>
              ...
              >
                ...
                <DataGrid.Column headerName="District " field="DistrictMasterName" width={240} />
                ...
                autoGroupColumnDef={{
                  ...
                  cellRendererParams: {
                    innerRenderer: (params) => {
                      return params.data.SubDistrictMasterName;
                    },
                  },
                }}
              >
                <DataGrid.Column headerName="SubDistrict Name" field="SubDistrictMasterName" width={150} />
                <DataGrid.Column
                  headerName="Action"
                  lockPosition="1"
                  pinned="left"
...
export default SubDistrictAssignModal;

SubDistrictAssignModal.propTypes = {
